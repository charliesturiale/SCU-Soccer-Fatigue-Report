...
def main():
    ...
    # 
    # PASTE ACTIVITY ID AND ACTIVITY NAME HERE
    # 
    # activityId = "e92f11e7-6b5b-4629-a024-4a79d6cff89e" # vs Pepperdine 10/8/25
    # activityId = "e299a017-7ce2-475b-ade4-61385572a6d6" # vs Seattle 10/4/25
    ...
    payload = {
        "parameters": ["total_distance", "average_player_load", "ima_band3_jump_count"],
        "filters": [
            {
                "comparison": "=",
                "name": "activity_id",
